...
namespace NavisionServiceApp
{
    ...
    class FileTransfer
    {
        ...
        public void SendFile(string name, string custid)
        {

        }

        public string GetFile(string name,string custid)
        {
            return "";
        }

        public bool DeleteFile(string name,string custid)
        {
            return true;
        } 
        ...
        public List<string> GetFilesIn(string custid)
        {
            // Get files going IN 
            List<string> result = new List<string>(); ;
            return result;
        ...
        public List<string> GetFilesOut(string custid)
        {
            // Get files going OUT 
            List<string> result = new List<string>(); ;
            return result;
